...
static esp_err_t bsp_enable_dsi_phy_power(void)
{
    ...
    void InitializeLCD()
    {
        ...
        esp_lcd_dpi_panel_config_t dpi_config = JD9365_800_1280_PANEL_60HZ_DPI_CONFIG_XIAOZHI(LCD_COLOR_PIXEL_FORMAT_RGB565);
...
public:
    jc1060p4a1() : boot_button_(BOOT_BUTTON_GPIO) {  
